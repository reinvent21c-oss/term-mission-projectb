...
| 저장소 | Notion Database |
| 알림 | Discord Webhook |
| 실행 주기 | 매일 오전 10:00 (Daily schedule) |
...
| 역할 | 이름 | 담당 업무 |
|------|------|-----------|
| 팀장 | [팀장 이름] | 전체 기획, Make 시나리오 설계, 발표 |
| 팀원 | [팀원 이름] | Gemini API 연동, 프롬프트 작성 |
| 팀원 | [팀원 이름] | Notion DB 구성, 필드 매핑 |
| 팀원 | [팀원 이름] | Discord 웹훅 연동, 에러 처리 |
| 팀원 | [팀원 이름] | 테스트 및 검증, README 작성 |

> 팀 구성 및 담당 업무는 실제 분담 내용에 맞게 수정하세요.
